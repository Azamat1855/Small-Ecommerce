...
const Navbar = () => {
  return (
    <nav className="bg-[#17140c] flex items-center py-[30px]">
      <div className="w-[85%] mx-auto flex items-center justify-between">
      <div className="text-white bg-[#47a51f] w-[70px] h-[70px] rounded-full flex justify-center items-center absolute">LOGO</div>
